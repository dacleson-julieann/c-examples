// program to check uppercase using isupper() function

/*
in this program we will check whether a character is in upper-case or not. we will
be using a system defined function isupper() defined under the ctype.h library

This can also be done using if-else blocks condition using the range of the
ASCII values of the upper-case alphabets which is 65 to 90.

This method is used for various valid password checking options where
atleast one upper-case character is mandatory.
*/
